...
class MembresiaadminController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('membresiaadmin.index')->with('success','Registro creado satisfactoriamente');
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('membresiaadmin.index')->with('success','Registro eliminado satisfactoriamente');
