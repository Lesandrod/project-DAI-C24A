		...
		@if (count($errors) > 0)
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">Añadir Pelicula</h3>
				</div>
				<div class="card  bg-glass">					
				<div class="card-body p-4">
						
						<form method="POST" class="m-5" action="{{ route('adminpelicula.store') }}"  role="form">
						{{ csrf_field() }}
						<div class="form-group row m-2">
							<label for="nombre" class="col-4 col-form-label">Nombre</label> 
							<div class="col-8">
							<input id="nombre" name="nombre" placeholder="Nombre de la película" type="text" class="form-control" required="required">
							</div>
						</div>
						<div class="form-group row m-2">
							<label for="director" class="col-4 col-form-label">Director</label> 
							<div class="col-8">
							<input id="director" name="director" placeholder="Nombre del director" type="text" class="form-control" required="required">
							</div>
						</div>
						<div class="form-group row m-2">
							<label for="genero" class="col-4 col-form-label">Género</label> 
							<div class="col-8">
							<select id="genero" name="genero" class="form-select" required="required">
						...
						<div class="form-group row m-2">
							...
							<div class="col-8">
							<input id="actor1" name="actor1" placeholder="Actor" type="text" class="form-control" required="required">
							</div>
						</div>
						<div class="form-group row m-2">
							<label for="actor2" class="col-4 col-form-label">Actor</label> 
							<div class="col-8">
							<input id="actor2" name="actor2" placeholder="Actor" type="text" class="form-control" required="required">
							</div>
						</div> 
						<div class="form-group row m-2 " >
