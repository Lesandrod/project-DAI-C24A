...
<div class="flex justify-between h-16">
    <div class="flex">
        ...
        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
            <x-jet-nav-link href="{{ route('adminpelicula.index') }}" :active="request()->routeIs('adminpelicula.index')">
                {{ __('Peliculas') }}
            </x-jet-nav-link>
        </div>
        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body" style="width:130%;">
                    ...
                    <div class="row mb-3 justify-content-center">
                        <label for="colFormLabel" class="col-sm-3 col-form-label">Rol :</label>
                        <div class="col-sm-3">
