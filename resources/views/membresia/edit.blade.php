			...
			<div class="panel panel-default">
				...
				<div class="card-body p-4">
						...
						<div class="form-group row m-2">
							...
							<div class="col-8">
							<input type="number" name="user_id" id="user_id" placeholder="Id de usuario" class="form-control" required="required" value="{{$membresia->user_id}}">
							</div>
						</div>
						<div class="form-group row m-2">
						...
						<div class="form-group row m-2 " >
								...
								<div class="col-xs-12 col-sm-12 col-md-12" style="text-align:center;">
									...
									<a href="{{ route('membresiaadmin.index') }}" class="btn btn-info btn-block" >Atrás</a>
								</div>	
